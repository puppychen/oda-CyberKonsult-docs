...
> 📦 **Spec Pack**（試點功能 #2）：[`docs/04-features/cleaning-maker-checker/`](../04-features/cleaning-maker-checker/) — requirements / design / tasks 三件套；含 TYPE-COMPARE-01、MC-INVARIANT-01、ACTOR-INJECTION-01、STATE-FLOW-01、ROW-LOCK-01、AUDIT-01、PSEUDO-TEST-01 七條功能特殊規則；於 2026-05-02 建立，採修正版 D5（dry-run 立刻測 + +7 天補強觀察期至 2026-05-09）。
