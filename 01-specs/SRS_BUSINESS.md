...
| 屬性 | 描述 |
|------|------|
| 角色描述 | 僅需基本資安諮詢的企業員工，系統預設角色 |
| 核心需求 | 以簡單易懂的方式獲得資安基礎知識 |
| 技術水平 | 低（無技術背景） |
| 使用頻率 | 偶爾 |
| 備註 | 僅可使用 beginner 模式，不可切換回應模式 |
...
| 應用程式 | Basic User | User | IT User | Consultant | Data Cleaner | Data Reviewer | Admin | Platform Admin |
|----------|:----------:|:----:|:-------:|:----------:|:------------:|:-------------:|:-----:|:--------------:|
| Chatbot UI | ✓ | ✓ | ✓ | ✓ | ✗ | ✗ | ✓ | ✓ |
| Admin Dashboard | ✗ | ✗ | ✗ | ✗ | ✗ | ✗ | ✓ | ✓ |
| Cleaner App | ✗ | ✗ | ✗ | ✗ | ✓ | ✓ | ✓ | ✓ |
...
| 需求 | Basic User | User | IT User | Consultant | Data Cleaner | Data Reviewer | Admin | Platform Admin |
|------|:----------:|:----:|:-------:|:----------:|:------------:|:-------------:|:-----:|:--------------:|
| **對話功能** |
| 使用對話介面 | ✓ | ✓ | ✓ | ✓ | ✗ | ✗ | ✓ | ✓ |
| 查看自己歷史對話 | ✓ | ✓ | ✓ | ✓ | ✗ | ✗ | ✓ | ✓ |
...
| **角色權限控制** | 依角色限制功能存取（8 角色：basic_user / user / it_user / consultant / data_cleaner / data_reviewer / admin / platform_admin） |
...
| 里程碑 | 預計時程 | 交付項目 |
|--------|----------|----------|
| **M1: 核心功能上線**（已完成） | Q1 2026 | 核心 RAG + 資料清洗 + Maker-Checker 審核 + 認證授權 + 提示詞管理 + 角色權限（8 角色）+ 三層模式 + Cleaner App + Analytics Dashboard |
